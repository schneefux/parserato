...
test('should write Serato data to mp3', async () => {
  ...
  expect(tags).toMatchObject({
    ...
    "Serato Markers2": "",
    /* "Serato Offsets_": "...", */
    /* "Serato Overview": "...", */
  })
