import SeratoCueMarker from "./marker/SeratoCueMarker"
import SeratoColorMarker from "./marker/SeratoColorMarker"
import SeratoBpmLockMarker from "./marker/SeratoBpmLockMarker"
...
test('should decode Serato Markers 2 frame', () => {
  const frame = encoder.decode(testFrameSeratoMarkers2)!
