...
const testFrameSeratoMarkers2 = Buffer.from('', 'hex')
...
test('should encode to Serato Markers 2 frame', () => {
...
test('should encode to Serato Markers 2 frame with no cues', () => {
  const markers2NoCues = Buffer.from('', 'base64')
  const frame = new SeratoMarkers2Frame()
  ...
  expect(encoder.encode(frame).toString('hex')).toBe(markers2NoCues.toString('hex'))
})
