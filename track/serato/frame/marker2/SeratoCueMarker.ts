...
/**
 * Implements a marker that stores cue information.
 *
 * @see https://support.serato.com/hc/en-us/articles/360000067696-Cue-Points
 */
export default class SeratoCueMarker implements SeratoMarker2 {
  id = 'CUE'
  index: number = 0
